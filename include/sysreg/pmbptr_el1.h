...
static const union pmbptr_el1 PMBPTR_EL1_SAFEVAL =
{0
};



static inline union pmbptr_el1 read_pmbptr_el1( void )
{
...
static inline void unsafe_write_pmbptr_el1( union pmbptr_el1 val )
{
    __asm(
        "MSR s3_0_c9_c10_1, %0"
        : /**/ : "r" (val._)
...
#define safe_write_pmbptr_el1( ... ) \
    do \
    { \
        union pmbptr_el1 tmp = PMBPTR_EL1_SAFEVAL; \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_pmbptr_el1(tmp); \
    } while (0)



#define read_modify_write_pmbptr_el1( ... ) \
    do \
    { \
        union pmbptr_el1 tmp = read_pmbptr_el1(); \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_pmbptr_el1(tmp); \
    } while (0)
