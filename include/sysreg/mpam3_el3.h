...
static const union mpam3_el3 MPAM3_EL3_SAFEVAL =
{0
};



static inline union mpam3_el3 read_mpam3_el3( void )
{
    union mpam3_el3 tmp;
    __asm(
        "MRS %0, s3_6_c10_c5_0"
...
static inline void unsafe_write_mpam3_el3( union mpam3_el3 val )
{
    __asm(
        "MSR s3_6_c10_c5_0, %0"
        : /**/ : "r" (val._)
...
#define safe_write_mpam3_el3( ... ) \
    do \
    { \
        union mpam3_el3 tmp = MPAM3_EL3_SAFEVAL; \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_mpam3_el3(tmp); \
    } while (0)



#define read_modify_write_mpam3_el3( ... ) \
    do \
    { \
        union mpam3_el3 tmp = read_mpam3_el3(); \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_mpam3_el3(tmp); \
    } while (0)
