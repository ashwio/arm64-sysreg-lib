...
static const union dbgprcr_el1 DBGPRCR_EL1_SAFEVAL =
{0
};



static inline union dbgprcr_el1 read_dbgprcr_el1( void )
{
...
static inline void unsafe_write_dbgprcr_el1( union dbgprcr_el1 val )
{
    __asm(
        "MSR s2_0_c1_c4_4, %0"
        : /**/ : "r" (val._)
...
#define safe_write_dbgprcr_el1( ... ) \
    do \
    { \
        union dbgprcr_el1 tmp = DBGPRCR_EL1_SAFEVAL; \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_dbgprcr_el1(tmp); \
    } while (0)



#define read_modify_write_dbgprcr_el1( ... ) \
    do \
    { \
        union dbgprcr_el1 tmp = read_dbgprcr_el1(); \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_dbgprcr_el1(tmp); \
    } while (0)
