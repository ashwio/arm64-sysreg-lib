...
static const union apibkeylo_el1 APIBKEYLO_EL1_SAFEVAL =
{0
};



static inline union apibkeylo_el1 read_apibkeylo_el1( void )
{
...
static inline void unsafe_write_apibkeylo_el1( union apibkeylo_el1 val )
{
    __asm(
        "MSR s3_0_c2_c1_2, %0"
        : /**/ : "r" (val._)
...
#define safe_write_apibkeylo_el1( ... ) \
    do \
    { \
        union apibkeylo_el1 tmp = APIBKEYLO_EL1_SAFEVAL; \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_apibkeylo_el1(tmp); \
    } while (0)



#define read_modify_write_apibkeylo_el1( ... ) \
    do \
    { \
        union apibkeylo_el1 tmp = read_apibkeylo_el1(); \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_apibkeylo_el1(tmp); \
    } while (0)
