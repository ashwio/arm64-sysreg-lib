...
static const union scxtnum_el1 SCXTNUM_EL1_SAFEVAL =
{0
};



static inline union scxtnum_el1 read_scxtnum_el1( void )
{
...
static inline void unsafe_write_scxtnum_el1( union scxtnum_el1 val )
{
    __asm(
        "MSR s3_0_c13_c0_7, %0"
        : /**/ : "r" (val._)
...
#define safe_write_scxtnum_el1( ... ) \
    do \
    { \
        union scxtnum_el1 tmp = SCXTNUM_EL1_SAFEVAL; \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_scxtnum_el1(tmp); \
    } while (0)



#define read_modify_write_scxtnum_el1( ... ) \
    do \
    { \
        union scxtnum_el1 tmp = read_scxtnum_el1(); \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_scxtnum_el1(tmp); \
    } while (0)
