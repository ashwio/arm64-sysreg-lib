...
static const union mpam2_el2 MPAM2_EL2_SAFEVAL =
{0
};



static inline union mpam2_el2 read_mpam2_el2( void )
{
    union mpam2_el2 tmp;
    __asm(
        "MRS %0, s3_4_c10_c5_0"
...
static inline void unsafe_write_mpam2_el2( union mpam2_el2 val )
{
    __asm(
        "MSR s3_4_c10_c5_0, %0"
        : /**/ : "r" (val._)
...
#define safe_write_mpam2_el2( ... ) \
    do \
    { \
        union mpam2_el2 tmp = MPAM2_EL2_SAFEVAL; \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_mpam2_el2(tmp); \
    } while (0)



#define read_modify_write_mpam2_el2( ... ) \
    do \
    { \
        union mpam2_el2 tmp = read_mpam2_el2(); \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_mpam2_el2(tmp); \
    } while (0)
