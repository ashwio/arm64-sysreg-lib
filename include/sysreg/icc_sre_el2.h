...
static const union icc_sre_el2 ICC_SRE_EL2_SAFEVAL =
{0
};



static inline union icc_sre_el2 read_icc_sre_el2( void )
{
...
static inline void unsafe_write_icc_sre_el2( union icc_sre_el2 val )
{
    __asm(
        "MSR s3_4_c12_c9_5, %0"
        : /**/ : "r" (val._)
...
#define safe_write_icc_sre_el2( ... ) \
    do \
    { \
        union icc_sre_el2 tmp = ICC_SRE_EL2_SAFEVAL; \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_icc_sre_el2(tmp); \
    } while (0)



#define read_modify_write_icc_sre_el2( ... ) \
    do \
    { \
        union icc_sre_el2 tmp = read_icc_sre_el2(); \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_icc_sre_el2(tmp); \
    } while (0)
