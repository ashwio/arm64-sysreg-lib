...
static const union mpam0_el1 MPAM0_EL1_SAFEVAL =
{0
};



static inline union mpam0_el1 read_mpam0_el1( void )
{
    union mpam0_el1 tmp;
    __asm(
        "MRS %0, s3_0_c10_c5_1"
...
static inline void unsafe_write_mpam0_el1( union mpam0_el1 val )
{
    __asm(
        "MSR s3_0_c10_c5_1, %0"
        : /**/ : "r" (val._)
...
#define safe_write_mpam0_el1( ... ) \
    do \
    { \
        union mpam0_el1 tmp = MPAM0_EL1_SAFEVAL; \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_mpam0_el1(tmp); \
    } while (0)



#define read_modify_write_mpam0_el1( ... ) \
    do \
    { \
        union mpam0_el1 tmp = read_mpam0_el1(); \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_mpam0_el1(tmp); \
    } while (0)
