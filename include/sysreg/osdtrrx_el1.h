...
union osdtrrx_el1
{
    ...
    __extension__ struct {
        u64 Update_DTRRX_without_side_effect : 32;
        u64 res0_63_32 : 32;
    };
};
...
static const union osdtrrx_el1 OSDTRRX_EL1_SAFEVAL =
{0
};



static inline union osdtrrx_el1 read_osdtrrx_el1( void )
{
...
static inline void unsafe_write_osdtrrx_el1( union osdtrrx_el1 val )
{
    __asm(
        "MSR s2_0_c0_c0_2, %0"
        : /**/ : "r" (val._)
...
#define safe_write_osdtrrx_el1( ... ) \
    do \
    { \
        union osdtrrx_el1 tmp = OSDTRRX_EL1_SAFEVAL; \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_osdtrrx_el1(tmp); \
    } while (0)



#define read_modify_write_osdtrrx_el1( ... ) \
    do \
    { \
        union osdtrrx_el1 tmp = read_osdtrrx_el1(); \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_osdtrrx_el1(tmp); \
    } while (0)
