...
static const union apiakeyhi_el1 APIAKEYHI_EL1_SAFEVAL =
{0
};



static inline union apiakeyhi_el1 read_apiakeyhi_el1( void )
{
...
static inline void unsafe_write_apiakeyhi_el1( union apiakeyhi_el1 val )
{
    __asm(
        "MSR s3_0_c2_c1_1, %0"
        : /**/ : "r" (val._)
...
#define safe_write_apiakeyhi_el1( ... ) \
    do \
    { \
        union apiakeyhi_el1 tmp = APIAKEYHI_EL1_SAFEVAL; \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_apiakeyhi_el1(tmp); \
    } while (0)



#define read_modify_write_apiakeyhi_el1( ... ) \
    do \
    { \
        union apiakeyhi_el1 tmp = read_apiakeyhi_el1(); \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_apiakeyhi_el1(tmp); \
    } while (0)
