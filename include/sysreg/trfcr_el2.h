...
static const union trfcr_el2 TRFCR_EL2_SAFEVAL =
{0
};



static inline union trfcr_el2 read_trfcr_el2( void )
{
    union trfcr_el2 tmp;
    __asm(
        "MRS %0, s3_4_c1_c2_1"
...
static inline void unsafe_write_trfcr_el2( union trfcr_el2 val )
{
    __asm(
        "MSR s3_4_c1_c2_1, %0"
        : /**/ : "r" (val._)
...
#define safe_write_trfcr_el2( ... ) \
    do \
    { \
        union trfcr_el2 tmp = TRFCR_EL2_SAFEVAL; \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_trfcr_el2(tmp); \
    } while (0)



#define read_modify_write_trfcr_el2( ... ) \
    do \
    { \
        union trfcr_el2 tmp = read_trfcr_el2(); \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_trfcr_el2(tmp); \
    } while (0)
