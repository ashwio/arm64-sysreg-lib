...
static const union pmccfiltr_el0 PMCCFILTR_EL0_SAFEVAL =
{0
};



static inline union pmccfiltr_el0 read_pmccfiltr_el0( void )
{
...
static inline void unsafe_write_pmccfiltr_el0( union pmccfiltr_el0 val )
{
    __asm(
...
#define safe_write_pmccfiltr_el0( ... ) \
    do \
    { \
        union pmccfiltr_el0 tmp = PMCCFILTR_EL0_SAFEVAL; \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_pmccfiltr_el0(tmp); \
    } while (0)



#define read_modify_write_pmccfiltr_el0( ... ) \
    do \
    { \
        union pmccfiltr_el0 tmp = read_pmccfiltr_el0(); \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_pmccfiltr_el0(tmp); \
    } while (0)
