...
static const union dbgclaimclr_el1 DBGCLAIMCLR_EL1_SAFEVAL =
{0
};



static inline union dbgclaimclr_el1 read_dbgclaimclr_el1( void )
{
...
static inline void unsafe_write_dbgclaimclr_el1( union dbgclaimclr_el1 val )
{
    __asm(
        "MSR s2_0_c7_c9_6, %0"
        : /**/ : "r" (val._)
...
#define safe_write_dbgclaimclr_el1( ... ) \
    do \
    { \
        union dbgclaimclr_el1 tmp = DBGCLAIMCLR_EL1_SAFEVAL; \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_dbgclaimclr_el1(tmp); \
    } while (0)



#define read_modify_write_dbgclaimclr_el1( ... ) \
    do \
    { \
        union dbgclaimclr_el1 tmp = read_dbgclaimclr_el1(); \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_dbgclaimclr_el1(tmp); \
    } while (0)
