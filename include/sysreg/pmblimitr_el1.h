...
static const union pmblimitr_el1 PMBLIMITR_EL1_SAFEVAL =
{0
};



static inline union pmblimitr_el1 read_pmblimitr_el1( void )
{
...
static inline void unsafe_write_pmblimitr_el1( union pmblimitr_el1 val )
{
    __asm(
        "MSR s3_0_c9_c10_0, %0"
        : /**/ : "r" (val._)
...
#define safe_write_pmblimitr_el1( ... ) \
    do \
    { \
        union pmblimitr_el1 tmp = PMBLIMITR_EL1_SAFEVAL; \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_pmblimitr_el1(tmp); \
    } while (0)



#define read_modify_write_pmblimitr_el1( ... ) \
    do \
    { \
        union pmblimitr_el1 tmp = read_pmblimitr_el1(); \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_pmblimitr_el1(tmp); \
    } while (0)
