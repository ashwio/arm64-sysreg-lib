...
union vbar_el1
{
    ...
    __extension__ struct {
        u64 res0_10_0 : 11;
        u64 Vector_Base_Address : 53;
    };
};



static const union vbar_el1 VBAR_EL1_SAFEVAL =
{0
};



static inline union vbar_el1 read_vbar_el1( void )
{
    union vbar_el1 tmp;
    __asm(
        "MRS %0, s3_0_c12_c0_0"
...
static inline void unsafe_write_vbar_el1( union vbar_el1 val )
{
    __asm(
        "MSR s3_0_c12_c0_0, %0"
        : /**/ : "r" (val._)
...
#define safe_write_vbar_el1( ... ) \
    do \
    { \
        union vbar_el1 tmp = VBAR_EL1_SAFEVAL; \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_vbar_el1(tmp); \
    } while (0)



#define read_modify_write_vbar_el1( ... ) \
    do \
    { \
        union vbar_el1 tmp = read_vbar_el1(); \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_vbar_el1(tmp); \
    } while (0)
