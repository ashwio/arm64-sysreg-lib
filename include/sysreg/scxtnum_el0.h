...
static const union scxtnum_el0 SCXTNUM_EL0_SAFEVAL =
{0
};



static inline union scxtnum_el0 read_scxtnum_el0( void )
{
...
static inline void unsafe_write_scxtnum_el0( union scxtnum_el0 val )
{
    __asm(
        "MSR s3_3_c13_c0_7, %0"
        : /**/ : "r" (val._)
...
#define safe_write_scxtnum_el0( ... ) \
    do \
    { \
        union scxtnum_el0 tmp = SCXTNUM_EL0_SAFEVAL; \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_scxtnum_el0(tmp); \
    } while (0)



#define read_modify_write_scxtnum_el0( ... ) \
    do \
    { \
        union scxtnum_el0 tmp = read_scxtnum_el0(); \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_scxtnum_el0(tmp); \
    } while (0)
