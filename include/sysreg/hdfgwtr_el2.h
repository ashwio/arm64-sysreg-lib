...
static const union hdfgwtr_el2 HDFGWTR_EL2_SAFEVAL =
{0
};



static inline union hdfgwtr_el2 read_hdfgwtr_el2( void )
{
...
static inline void unsafe_write_hdfgwtr_el2( union hdfgwtr_el2 val )
{
    __asm(
        "MSR s3_4_c3_c1_5, %0"
        : /**/ : "r" (val._)
...
#define safe_write_hdfgwtr_el2( ... ) \
    do \
    { \
        union hdfgwtr_el2 tmp = HDFGWTR_EL2_SAFEVAL; \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_hdfgwtr_el2(tmp); \
    } while (0)



#define read_modify_write_hdfgwtr_el2( ... ) \
    do \
    { \
        union hdfgwtr_el2 tmp = read_hdfgwtr_el2(); \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_hdfgwtr_el2(tmp); \
    } while (0)
