...
static const union mpamvpm1_el2 MPAMVPM1_EL2_SAFEVAL =
{0
};



static inline union mpamvpm1_el2 read_mpamvpm1_el2( void )
{
...
static inline void unsafe_write_mpamvpm1_el2( union mpamvpm1_el2 val )
{
    __asm(
        "MSR s3_4_c10_c6_1, %0"
        : /**/ : "r" (val._)
...
#define safe_write_mpamvpm1_el2( ... ) \
    do \
    { \
        union mpamvpm1_el2 tmp = MPAMVPM1_EL2_SAFEVAL; \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_mpamvpm1_el2(tmp); \
    } while (0)



#define read_modify_write_mpamvpm1_el2( ... ) \
    do \
    { \
        union mpamvpm1_el2 tmp = read_mpamvpm1_el2(); \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_mpamvpm1_el2(tmp); \
    } while (0)
