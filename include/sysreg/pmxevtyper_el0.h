...
union pmxevtyper_el0
{
    ...
    __extension__ struct {
        u64 Event_type_register_or_PMCCFILTR_EL0 : 32;
        u64 res0_63_32 : 32;
    };
};
...
static const union pmxevtyper_el0 PMXEVTYPER_EL0_SAFEVAL =
{0
};



static inline union pmxevtyper_el0 read_pmxevtyper_el0( void )
{
...
static inline void unsafe_write_pmxevtyper_el0( union pmxevtyper_el0 val )
{
    __asm(
        "MSR s3_3_c9_c13_1, %0"
        : /**/ : "r" (val._)
...
#define safe_write_pmxevtyper_el0( ... ) \
    do \
    { \
        union pmxevtyper_el0 tmp = PMXEVTYPER_EL0_SAFEVAL; \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_pmxevtyper_el0(tmp); \
    } while (0)



#define read_modify_write_pmxevtyper_el0( ... ) \
    do \
    { \
        union pmxevtyper_el0 tmp = read_pmxevtyper_el0(); \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_pmxevtyper_el0(tmp); \
    } while (0)
