...
static const union pmslatfr_el1 PMSLATFR_EL1_SAFEVAL =
{0
};



static inline union pmslatfr_el1 read_pmslatfr_el1( void )
{
...
static inline void unsafe_write_pmslatfr_el1( union pmslatfr_el1 val )
{
    __asm(
        "MSR s3_0_c9_c9_6, %0"
        : /**/ : "r" (val._)
...
#define safe_write_pmslatfr_el1( ... ) \
    do \
    { \
        union pmslatfr_el1 tmp = PMSLATFR_EL1_SAFEVAL; \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_pmslatfr_el1(tmp); \
    } while (0)



#define read_modify_write_pmslatfr_el1( ... ) \
    do \
    { \
        union pmslatfr_el1 tmp = read_pmslatfr_el1(); \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_pmslatfr_el1(tmp); \
    } while (0)
