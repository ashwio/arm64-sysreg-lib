...
static const union apdakeyhi_el1 APDAKEYHI_EL1_SAFEVAL =
{0
};



static inline union apdakeyhi_el1 read_apdakeyhi_el1( void )
{
...
static inline void unsafe_write_apdakeyhi_el1( union apdakeyhi_el1 val )
{
    __asm(
        "MSR s3_0_c2_c2_1, %0"
        : /**/ : "r" (val._)
...
#define safe_write_apdakeyhi_el1( ... ) \
    do \
    { \
        union apdakeyhi_el1 tmp = APDAKEYHI_EL1_SAFEVAL; \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_apdakeyhi_el1(tmp); \
    } while (0)



#define read_modify_write_apdakeyhi_el1( ... ) \
    do \
    { \
        union apdakeyhi_el1 tmp = read_apdakeyhi_el1(); \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_apdakeyhi_el1(tmp); \
    } while (0)
