...
static const union amuserenr_el0 AMUSERENR_EL0_SAFEVAL =
{0
};



static inline union amuserenr_el0 read_amuserenr_el0( void )
{
...
static inline void unsafe_write_amuserenr_el0( union amuserenr_el0 val )
{
    __asm(
        "MSR s3_3_c13_c2_3, %0"
        : /**/ : "r" (val._)
...
#define safe_write_amuserenr_el0( ... ) \
    do \
    { \
        union amuserenr_el0 tmp = AMUSERENR_EL0_SAFEVAL; \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_amuserenr_el0(tmp); \
    } while (0)



#define read_modify_write_amuserenr_el0( ... ) \
    do \
    { \
        union amuserenr_el0 tmp = read_amuserenr_el0(); \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_amuserenr_el0(tmp); \
    } while (0)
