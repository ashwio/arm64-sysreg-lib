...
static const union lorsa_el1 LORSA_EL1_SAFEVAL =
{0
};



static inline union lorsa_el1 read_lorsa_el1( void )
{
    union lorsa_el1 tmp;
    __asm(
        "MRS %0, s3_0_c10_c4_0"
...
static inline void unsafe_write_lorsa_el1( union lorsa_el1 val )
{
    __asm(
        "MSR s3_0_c10_c4_0, %0"
        : /**/ : "r" (val._)
...
#define safe_write_lorsa_el1( ... ) \
    do \
    { \
        union lorsa_el1 tmp = LORSA_EL1_SAFEVAL; \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_lorsa_el1(tmp); \
    } while (0)



#define read_modify_write_lorsa_el1( ... ) \
    do \
    { \
        union lorsa_el1 tmp = read_lorsa_el1(); \
        ARM64_SYSREG_CALL_FOR_EACH(ARM64_SYSREG_SET, __VA_ARGS__) \
        unsafe_write_lorsa_el1(tmp); \
    } while (0)
